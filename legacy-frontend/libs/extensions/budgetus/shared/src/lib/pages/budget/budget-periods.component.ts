...
import { getLiabilitiesByPeriod } from '@sneat/extension-budgetus-contract';
import { LiabilitiesByPeriod, LiabilitiesMode } from '@sneat/extension-budgetus-contract';
import { BudgetPeriodComponent } from './budget-period.component';

@Component({
  selector: 'budgetus-budget-periods',
