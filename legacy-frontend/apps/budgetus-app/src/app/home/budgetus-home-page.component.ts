...
// Authenticated landing page for budgetus.app. Reuses the shared
  ...
  template: `
    <ion-header>
      <ion-toolbar>
        ...
        <ion-title>Budgetus.app</ion-title>
      </ion-toolbar>
    </ion-header>
...
export class BudgetusHomePageComponent {}
