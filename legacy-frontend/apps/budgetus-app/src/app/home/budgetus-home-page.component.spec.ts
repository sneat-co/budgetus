...
import { BudgetusHomePageComponent } from './budgetus-home-page.component';
...
describe('BudgetusHomePageComponent', () => {
  ...
  beforeEach(() =>
    TestBed.configureTestingModule({
      imports: [BudgetusHomePageComponent],
      providers: [
  ...
  it('renders the spaces list for a user with spaces (all DI resolves, no NG0201)', () => {
    const fixture = TestBed.createComponent(BudgetusHomePageComponent);
