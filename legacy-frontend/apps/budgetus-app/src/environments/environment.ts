...
// Single environment for budgetus — fail-safe by construction. appEnvironmentConfig
...
//
// Reuses the shared sneat production Firebase project (sneat-eur3-1) — budgetus
// shares auth, spaces and Firestore with the rest of the sneat ecosystem.
export const budgetusAppEnvironmentConfig: IEnvironmentConfig =
  appEnvironmentConfig({
    ...
    firebaseConfig: {
      ...
      // budgetus.app, budgetus-app.web.app, or a preview channel. (budgetus.app is a
