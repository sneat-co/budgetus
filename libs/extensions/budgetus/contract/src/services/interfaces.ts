...
// export abstract class IListService extends ICommuneItemService<IListDto, BudgetusAppSchema, typeof ListKind> {
// 	abstract deleteList(listId: string, communeId: string): Observable<IListDto>;
// }
//
// export abstract class IListItemService extends ICommuneItemService<IListItemDto, BudgetusAppSchema, typeof ListItemKind> {
// 	// noinspection JSUnusedGlobalSymbols
// 	// abstract txRemoveKinds(): string[];
//
// 	// noinspection JSUnusedGlobalSymbols
// 	abstract selectByListId(tx: IRxReadonlyTransaction<BudgetusAppSchema>, listId: string, status?: ListStatus)
...
// export abstract class IBudgetusService extends RxStoreService<BudgetusAppSchema> {
