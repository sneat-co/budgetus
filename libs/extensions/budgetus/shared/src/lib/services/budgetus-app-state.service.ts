...
export interface IBudgetusAppState {
  collapsedGroups: string[];
  showWatched: boolean;
}

export abstract class IBudgetusAppStateService extends LocalAppState<IBudgetusAppState> {
...
@Injectable()
export class BudgetusAppStateService extends IBudgetusAppStateService {
  constructor() {
  ...
  public setShowWatched(showWatched: boolean): void {
    const appState: IBudgetusAppState = {
      ...this.getAppState(),
      showWatched,
    };
    this.saveAppState(appState);
